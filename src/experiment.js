...
(function() {
    ...
    function woundRelease(speed) {
        const stringLength = 556 + ((FlywheelView.weight_obj.x - 385) / 3) * 30;
        createjs.Tween.get(FlywheelView.weight_obj)
            .to({ y: FlywheelView.weight_obj.y + 30, x: FlywheelView.weight_obj.x - 3 }, speed);
        createjs.Tween.get(FlywheelView.line_mask)
            .to({ y: FlywheelView.weight_obj.y + 30 }, speed);
    }
